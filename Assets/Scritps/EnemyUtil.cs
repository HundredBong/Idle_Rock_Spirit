...
{
    public static float GetTargetDistance(Transform playerTransform, out Enemy targetEnemy)
    {
        targetEnemy = null;
    ...
    public static Vector3 GetTargetPosition(Transform playerTransform, out Enemy targetEnemy)
    {
        targetEnemy = null;
        float targetDistance = float.MaxValue;
        Vector3 targetPosition = Vector3.zero;
